 ...
 * $Id: MissionReward.script.php 196432 2015-09-02 11:42:06Z ShiyuZhang $
 * 
 **************************************************************************/

 /**
 * @file $HeadURL: svn://192.168.1.80:3698/C/tags/card/rpcfw/rpcfw_1-0-41-55/module/world/mission/script/MissionReward.script.php $
...
$csvFile = 'bounty_reward.csv';
$outFileName = 'MISSION_REWARD';
...
$pos = 0;
$field_names = array(
		MissionCsvField::REWARDID => $pos++,
		MissionCsvField::REWARDARR => ($pos+=3)-1,
);
...
while(TRUE)
{
	...
	{
		if( $key ==  MissionCsvField::REWARDARR )
		{
	...
	$confList[$conf[MissionCsvField::REWARDID]] = $conf;
}
fclose($file);
//将内容写入文件中
