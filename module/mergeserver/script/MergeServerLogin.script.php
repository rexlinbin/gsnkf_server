 ...
 * $Id: MergeServerLogin.script.php 259698 2016-08-31 08:07:55Z BaoguoMeng $
 * 
 **************************************************************************/

 /**
 * @file $HeadURL: svn://192.168.1.80:3698/C/tags/card/rpcfw/rpcfw_1-0-41-55/module/mergeserver/script/MergeServerLogin.script.php $
...
$csvFile = 'hefu_accumulateactive.csv';
$outFileName = 'MERGESERVER_LOGIN';
...
while (TRUE)
{
	...
	$dayIndex = $tag[MergeServerDef::MSERVER_TYPE_LOGIN]["day_index"];
	$rewardIndex = $tag[MergeServerDef::MSERVER_TYPE_LOGIN]["reward_index"];
	$day = $data[$dayIndex];
...
fwrite($file, serialize($loginConfig));
fclose($file);
