 ...
 * $Id: EnSpend.class.php 259698 2016-08-31 08:07:55Z BaoguoMeng $
 * 
 **************************************************************************/

 /**
 * @file $HeadURL: svn://192.168.1.80:3698/C/tags/card/rpcfw/rpcfw_1-0-41-55/module/activity/spend/EnSpend.class.php $
...
{
	//消费累计解析函数
	public static function readSpendCSV( $arr )
	{
		$index = 0;
		$keyArr = array(
				'id' => $index++,
